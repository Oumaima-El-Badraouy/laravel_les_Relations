              ...
              <tbody>
                  @foreach($m as $module)
                      <tr>
                          ...
                          <td>
                            <a href="{{ route('articles.edit' , $module->id) }}" class="btn btn-warning btn-sm me-1">Modifier</a>

                            <form action="{{ route('articles.destroy',$module->id)}} " method="POST" style="display:inline-block">
                            @csrf
                            @method('DELETE')
